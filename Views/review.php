    ...
    <form action="<?php echo  FRONT_ROOT."Review/guardarReview" ?>" class = "d-flex w-100 justify-content-center" method = "post">
        <div class = "d-flex flex-column shadow p-3 mb-2 mt-5 bg-body rounded w-50 ">
            ...
            <div class="form-group">
                <h6>Cuidador</h6>
                <input type="textr" class="form-control" id="" placeholder="<?php echo $nombreKeeper ?>" name ="nombreKeeper"readonly>
            </div>
            <div class="form-group">
                <h6>Mascota</h6>
                <input type="textr" class="form-control" id="" placeholder="<?php echo $nombrePet ?>" name ="nombreMascota" readonly>
            </div>
